...
Laisser l'usage décider à ma place. Ce n'est pas moi qui juge ce qui manque depuis ma tête, c'est la table qui le révèle.
...
- **Arbitrage goût d'auteur / usage :** vote possible, à deux échelles — la table du jour (3 présents + moi = 4) ou le groupe élargi (une dizaine de potes potentiellement intéressés).
